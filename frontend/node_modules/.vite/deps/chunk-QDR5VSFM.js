import {
  ...
  step_default,
  string_default
} from "./chunk-QJVGV3EU.js";
import {
  compile,
  init_stylis,
  serialize,
  stringify
} from "./chunk-5DXIE4S6.js";
import {
  __commonJS,
  __toESM
...
function find_default(x2, y2, radius) {
  ...
  if (node)
    quads.push(new quad_default(node, x02, y0, x3, y3));
  if (radius == null)
    radius = Infinity;
  else {
  ...
  while (q = quads.pop()) {
    if (!(node = q.node) || (x12 = q.x0) > x3 || (y1 = q.y0) > y3 || (x22 = q.x1) < x02 || (y22 = q.y1) < y0)
      continue;
    if (node.length) {
  ...
  return {
    ...
    point: function(lambda1, phi1) {
      ...
      if (abs3(delta - pi3) < epsilon4) {
        ...
        if (abs3(lambda0 - sign0) < epsilon4)
          lambda0 -= sign0 * epsilon4;
        if (abs3(lambda1 - sign1) < epsilon4)
...
function overRest(func, start2, transform2) {
  ...
  return function() {
    var args = arguments, index = -1, length = nativeMax(args.length - start2, 0), array3 = Array(length);
    while (++index < length) {
...
var renderKatex = async (text2, config2) => {
  ...
  const { default: katex } = await import("./katex-7VFUOZX2.js");
...
var loader$m = async () => {
  const { diagram: diagram2 } = await import("./c4Diagram-3d4e48cf-POJIB7D6.js");
...
var loader$l = async () => {
  const { diagram: diagram2 } = await import("./flowDiagram-66a62f08-QOB34BKR.js");
...
var loader$k = async () => {
  const { diagram: diagram2 } = await import("./flowDiagram-v2-96b9c2cf-NUCDCE6J.js");
...
var loader$j = async () => {
  const { diagram: diagram2 } = await import("./erDiagram-9861fffd-M7T3WSQA.js");
...
var loader$i = async () => {
  const { diagram: diagram2 } = await import("./gitGraphDiagram-72cf32ee-KFFQ53CG.js");
...
var loader$h = async () => {
  const { diagram: diagram2 } = await import("./ganttDiagram-c361ad54-BXNLI3ZF.js");
...
var loader$g = async () => {
  const { diagram: diagram2 } = await import("./infoDiagram-f8f76790-F25BRQMM.js");
...
var loader$f = async () => {
  const { diagram: diagram2 } = await import("./pieDiagram-8a3498a8-3GOAFBFU.js");
...
var loader$e = async () => {
  const { diagram: diagram2 } = await import("./quadrantDiagram-120e2f19-WNT5DSMX.js");
...
var loader$d = async () => {
  const { diagram: diagram2 } = await import("./xychartDiagram-e933f94c-CRA24WGR.js");
...
var loader$c = async () => {
  const { diagram: diagram2 } = await import("./requirementDiagram-deff3bca-IMO7D7HG.js");
...
var loader$b = async () => {
  const { diagram: diagram2 } = await import("./sequenceDiagram-704730f1-Z2ZSGPDG.js");
...
var loader$a = async () => {
  const { diagram: diagram2 } = await import("./classDiagram-70f12bd4-HCFG7PGF.js");
...
var loader$9 = async () => {
  const { diagram: diagram2 } = await import("./classDiagram-v2-f2320105-4XOXB5QL.js");
...
var loader$8 = async () => {
  const { diagram: diagram2 } = await import("./stateDiagram-587899a1-CEKTZ7AR.js");
...
var loader$7 = async () => {
  const { diagram: diagram2 } = await import("./stateDiagram-v2-d93cdb3a-A6WJOXPZ.js");
...
var loader$6 = async () => {
  const { diagram: diagram2 } = await import("./journeyDiagram-49397b02-J7XD6QBY.js");
...
var loader$5 = async () => {
  const { diagram: diagram2 } = await import("./flowchart-elk-definition-4a651766-VXRWQGFF.js");
...
var loader$4 = async () => {
  const { diagram: diagram2 } = await import("./timeline-definition-85554ec2-U5HETILB.js");
...
var loader$3 = async () => {
  const { diagram: diagram2 } = await import("./mindmap-definition-fc14e90a-AT6LMQOZ.js");
...
var loader$2 = async () => {
  const { diagram: diagram2 } = await import("./sankeyDiagram-04a897e0-AQPHTXZK.js");
...
var loader$1 = async () => {
  const { diagram: diagram2 } = await import("./blockDiagram-38ab4fdb-45W3HZ2S.js");
...
var render$1 = async function(id22, text2, svgContainingElement) {
  ...
  const node = select_default2(tmpElementSelector).node();
...
mermaid/dist/mermaid-b5860b54.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-QDR5VSFM.js.map
